...
// interceptor (chat completions, responses, or messages). Multiple
// providers can build the same Config: Copilot, for example, reuses the
// OpenAI-format interceptors.
type Config struct {
