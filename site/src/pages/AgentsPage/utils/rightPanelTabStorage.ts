...
export function clearPersistedRightPanelTabs(chatID: string | undefined): void {
	if (!chatID) {
		return;
	}
...
export const defaultTerminalHiddenStorageKeyPrefix =
	"agents.default-terminal-hidden.";
