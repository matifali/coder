...
import { useTerminalWarmLifecycle } from "./useTerminalWarmLifecycle";
...
export const TerminalPanel: FC<TerminalPanelProps> = ({
	...
	const { connectionStatus, setConnectionStatus, shouldMountTerminal } =
		useTerminalWarmLifecycle({ isHot });
